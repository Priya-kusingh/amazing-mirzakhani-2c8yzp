...
import teamImage1 from "../img/Teacher.png";
...
const teamMembers = [
  {
    name: "Mr Jeetendra Kushwaha",
    image: teamImage1, // replace with the actual image source
  },
  {
    name: "Mr XYZ",
    image: teamImage1, // replace with the actual image source
...
const Certificate = () => {
  ...
  return (
    <div className="training-course-container">
      {/*_____________________PART______*/}

      <h2 className="Team"> Our Experience Facilities ​</h2>
