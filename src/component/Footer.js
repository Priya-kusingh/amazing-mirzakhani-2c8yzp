    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section contact">
          <h4>Contact Us</h4>
          <p>Address: Delhi NCR 110092.</p>
          <p>
            Mobile No: <a href="tel:+919565345676">+91 85273 45379</a>
          </p>
          <p>
            Email:{" "}
            <a href="mailto:techjobmentors@gmail.com ">
              {" "}
              techjobmentors@gmail.com{" "}
            </a>
          </p>
          <p>
            Email:{" "}
            <a href="mailto:jitendrakush@techmentor.com">
              jitendra.kush@techmentor.com
            </a>
          </p>
